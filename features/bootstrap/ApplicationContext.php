...
class ApplicationContext implements Context, MatchersProviderInterface
{
    ...
    /**
     * @When /^I start describing the "([^"]*)" class and passed the suite option "([^"]*)"$/
     * @Given /^I have started describing the "([^"]*)" class for "([^"]*)" suite$/
     */
    public function iStartDescribingTheClassAndPassedTheSuiteOption($class, $suite)
    {
        $arguments = array(
            'command' => 'describe',
            'class' => $class,
    ...
    /**
     * @When /^I start describing the "([^"]*)" class, it should result to an error$/
     */
    public function iStartDescribingTheClassItShouldResultToAnError($class)
    {
        $arguments = array(
            'command' => 'describe',
            'class' => $class
        ...
        expect($this->tester->run($arguments, array('interactive' => false)))->toBe(1);
    }
}
